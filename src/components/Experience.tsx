      ...
      >
        <div className="container">
          ...
          <div className="about-main">
            ...
            {/* Work Experience Details - Right Side */}
            <div className="about-right">
              ...
              >
                <div className="about-content">
                  <div style={{ marginBottom: "1rem", paddingBottom: "60px" }}>
                    <h3
                      style={{
                    ...
                    {currentExperience.achievements.map(
                      (achievement, achievementIndex) => (
                        ...
                        >
                          <span
                            style={{ color: "#cd1e49", marginRight: "0.5rem" }}
                          >
                            •
                          </span>
                          <p style={{ color: "#dddddd", fontSize: "0.95rem" }}>
                            {achievement}
                          </p>
                        </div>
                      )
